	...
	<page size="A4">
		...
		<div style="
			...
			<p style="margin-top: 1em; text-indent: 1em; text-align: justify;">
				Menerangkan bahwa nama diatas {!! $data['keterangan'] !!}.
			</p>	
			<p style="text-indent: 1em; text-align: justify; margin-bottom: 0px; margin-top: 0px;">
				Demikian surat keterangan ini saya buat dengan sebenar-benarnya untuk digunakan seperlunya tanpa adanya tekanan dan paksaan dari pihak manapun.
			</p>
			<table style="
				border: 0px solid;
			 	width: 100%;
