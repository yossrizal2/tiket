...
<head>
    ...
    <title>{{ config('app.name') }} - Referral Letter</title>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Surat Keterangan</h1>
                                <p>
                                    Masukan data dibawah ini lalu klik buat surat keterangan, maka sistem akan otomatis generate surat izin.
                                </p>
                            ...
                            <form class="user" action="{{ url('document/referral-letter-submit') }}" method="POST" enctype="multipart/form-data" target="_newtab">
                                @csrf
                                <label for="">
                                    <b>Identitas</b>
                                </label>
                                ...
                                <div class="form-group">
                                    <textarea name="keterangan" id="keterangan" class="form-control" placeholder="Menerangkan bahwa nama diatas ..." required></textarea>
                                        <p class="" style="font-size: 0.8em; font-style: italic;">
                                            contoh: "benar bahwa pernah bekerja sebagai staf IT di perusahaan ABC selama 3 tahun"
                                        </p>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control" id="nama_pembuat" name="nama_pembuat"
                                            placeholder="Nama Pembuat Surat" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="jabatan" name="jabatan"
                                        placeholder="Jabatan Pembuat Surat" required>
                                        <p class="" style="font-size: 0.8em; font-style: italic;">
                                            contoh: "HRD PT ABCD"
                                        </p>
                                    </div>
